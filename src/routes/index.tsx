      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Link to="/videos" className="px-4 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-amber-500/50 text-white text-sm font-semibold rounded-lg transition-all">Watch Videos</Link>
            <Link to="/partners" className="px-4 py-1.5 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-400 text-sm font-semibold rounded-lg transition-all">Recommended Tools</Link>
          </div>
        </div>
      </div>
    </section>
...
function FreeLearningSection() {
  ...
  const topics = [
    ...
    { icon: 'money', title: 'Caregiver Tax Basics', description: 'Most family caregivers overpay taxes without knowing it. We break down the deductions and credits you may be missing.', link: '/downloads', linkText: 'Get the Free Checklist' },
