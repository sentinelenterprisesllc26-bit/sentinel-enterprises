...
**Live domain:** sentinelenterprisesllc.com
...
Netlify Forms registered in `public/__forms.html`:
- `caregiver-checklist` — homepage caregiver email capture
- `crypto-checklist` — crypto inheritance checklist page email capture
- `crypto-security-checklist` — homepage crypto security email capture
- `sentinel-squad-notify` — Sentinel Squad notify waitlist
